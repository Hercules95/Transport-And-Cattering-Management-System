...
<!-- Mirrored from 115.160.244.10:8084/themeforest/event_planning/wishlist.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 25 Nov 2017 17:15:14 GMT -->
<head>
    <!-- Meta information -->
    <meta charset="utf-8">
...
<body class="inner-page">
    ...
    @include('frontend.header')
     ...
     <div class="simple-banner">
            <div class="banner-img">
                <img src="/frontend/images/blog-img/3.jpg" alt="">
            </div>
            <div class="text">
        	...
        	<div class="breadcrumb">
            	<div class="container">
                	<ul>
                        ...
                        <li class="active"><a href="#">Transport List</a></li>
                    </ul>
                </div>
            </div>
        	<div class="container">
                	...
                	<div class="row">
                    	<div class="col-lg-3 col-md-3 col-sm-12">
                        	<div class="left-side">
                                ...
                                <div class="map-link">
                                    <a href="#">
                                        <img src="/frontend/images/map-imgSmall.png" alt="">
                                ...
                                <div class="left-link">
                                    <h2>Quick Links</h2>
                                    <ul>
                                    	<li><a href="/Cattering/list"><span class="icon icon-arrow-right"></span>Catering Details</a></li>
                                        <li><a href="/FarmHouse/List"><span class="icon icon-arrow-right"></span>Farm House Details</a></li>
                                          <li><a href="/Transport/List"><span class="icon icon-arrow-right"></span>Transport Details</a></li>
                                    </ul>
                                </div>
                        	</div>
                        </div>
                        <div class="col-md-9 col-lg-9 col-sm-12">
                        	<div class="right-side">
                            	<div class="toolbar">
                                	...
                                	<div class="finde-count">Transport</div>
    ...
    <script type="text/javascript" src="/dist/Frontend/Transport/bundlelist.js"></script>
    
  </body>

<!-- Mirrored from 115.160.244.10:8084/themeforest/event_planning/wishlist.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 25 Nov 2017 17:15:17 GMT -->
</html>
