...
<body class="inner-page">
        	...
        	<div class="breadcrumb">
            	<div class="container">
                	<ul>
                        ...
                        <li class="active"><a href="#">Farm House List</a></li>
                    </ul>
                </div>
            </div>
        	<div class="container">
                                ...
                                <div class="left-link">
                                    ...
                                    <ul>
                                        ...
                                        <li><a href="/FarmHouse/List"><span class="icon icon-arrow-right"></span>Farm House Details</a></li>
                                          <li><a href="#"><span class="icon icon-arrow-right"></span>Transport Details</a></li>
                                    </ul>
                                </div>
                        	</div>
                        </div>
                        <div class="col-md-9 col-lg-9 col-sm-12">
                        	<div class="right-side">
                            	<div class="toolbar">
                                	...
                                	<div class="finde-count">Farm Houses</div>
    ...
    <script type="text/javascript" src="/dist/Frontend/FarmHouse/bundleFarmhouseImage.js"></script>
